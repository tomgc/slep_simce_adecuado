...
plantilla_tray <- paste(readLines(RUTA_PLANTILLA_TRAY, encoding = "UTF-8", warn = FALSE),
                        collapse = "\n")
html_tray <- reemplazar_literal_tray(plantilla_tray, MARCADOR_DATA_TRAY, json_tray)
