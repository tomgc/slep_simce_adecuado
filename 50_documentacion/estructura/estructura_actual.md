...
- **Fecha:** 2026-09-24 16:31:30
- **Totales:** 24 carpetas, 232 archivos
...
│   │   │   └── simce2m2025_rbd_final.xlsx  (528K)
│   │   ├── 4b/
│   │   │   ├── .gitkeep  (0)
...
│   │   │   └── simce4b2025_rbd_final.xlsx  (1.05M)
│   │   └── .DS_Store  (8K)
│   └── .DS_Store  (10K)
├── 30_procesamiento/
│   ├── 30_construir_auxiliares.R  (15.7K)
│   ├── 31_leer_normalizar.R  (16.3K)
│   ├── 32_agregar_comunal.R  (7.74K)
│   ├── 33_fragmento_sitio.html  (4.67K)
│   ├── 33_generar_html.R  (21.6K)
│   ├── 33_motor_template.html  (196K)
│   ├── 34_historico_pct_adecuado_costa_central.R  (6.19K)
│   ├── 36_funciones_trayectorias.R  (20.1K)
│   ├── 36_generar_trayectorias.R  (5.45K)
│   ├── 36_trayectorias_template.html  (60K)
│   └── 36_verificar_trayectorias.R  (19.5K)
├── 40_salidas/
│   ├── intermedios/
│   │   ├── .gitkeep  (0)
...
│   ├── activa/
│   │   ├── decisiones/
│   │   │   ├── 20260611_decision_color_por_nivel.md  (3.02K)
...
│   │   │   ├── encargo_memos_y_rutas_no_ejercidas.md  (14.6K)
│   │   │   ├── encargo_normalizar_backlog_politica10.md  (14.1K)
│   │   │   ├── encargo_ordenacion_repositorio.md  (10.1K)
│   │   │   ├── encargo_pendientes_inmediatos_s29.md  (29.1K)
│   │   │   ├── encargo_renombrar_entidad_territorio.md  (11.2K)
│   │   │   ├── encargo_rescate_rotulos_y_precedente_c3.md  (14.3K)
│   │   │   ├── encargo_retiro_cdn_v8_adenda.md  (3.44K)
│   │   │   ├── encargo_retiro_cdn_v8.md  (17.2K)
│   │   │   ├── encargo_simce2025_final.md  (12K)
│   │   │   ├── encargo_traslado_trayectorias_adenda.md  (6.02K)
│   │   │   ├── encargo_traslado_trayectorias_reanudacion.md  (6.14K)
│   │   │   ├── encargo_traslado_trayectorias.md  (14.4K)
│   │   │   └── encargo_verificacion_dudas_s29.md  (18.6K)
│   │   ├── .DS_Store  (8K)
│   │   ├── .gitkeep  (0)
│   │   ├── 50_datos_versionados_autorizados.md  (6.73K)
│   │   ├── 50_diseno_ramas_deteccion.md  (15.4K)
│   │   ├── 50_locale_utf8.md  (5.77K)
│   │   ├── 50_ordenacion_repositorio.md  (4.51K)
│   │   ├── 50_revision_safari_trayectorias.md  (4.03K)
│   │   ├── arquitectura_slep_simce_adecuado.html  (20K)
│   │   ├── backlog_acumulativo.md  (65.5K)
...
│   │   ├── publicacion_github_pages.md  (3.97K)
...
│   │   │   ├── 20260829_memos_y_rutas_no_ejercidas_log.md  (29.2K)
│   │   │   ├── 20260829_pendientes_inmediatos_s29_log.md  (31K)
...
│   │   │   ├── 20260923_retiro_cdn_v8_adenda_log.md  (48.9K)
│   │   │   ├── 20260923_retiro_cdn_v8_log.md  (86.2K)
│   │   │   ├── 20260923_sesion31_errores_asistente.md  (8.04K)
│   │   │   ├── 20260923_sesion32_errores_asistente.md  (5.54K)
│   │   │   ├── 20260923_simce2025_final_log.md  (81.1K)
...
│   │   │   ├── 20260924_sesion34_errores_asistente.md  (2.68K)
│   │   │   └── cierres_log.md  (48.4K)
│   │   ├── .DS_Store  (8K)
...
│   │   ├── paquete_cierre_v34.md  (31.4K)
│   │   └── verificar_trayectorias.R  (6.25K)
│   ├── estructura/
│   │   ├── 20260924_091740_estructura.md  (14.2K)
│   │   ├── 20260924_091740_estructura.txt  (14.3K)
│   │   ├── 20260924_141324_estructura.md  (14.5K)
│   │   ├── 20260924_141324_estructura.txt  (14.6K)
│   │   ├── estructura_actual.md  (14.5K)
│   │   └── estructura_actual.txt  (14.6K)
│   ├── suite/
│   │   ├── assets/
...
│   │   ├── .gitkeep  (0)
│   │   └── traspaso_cierre_v33.md  (28K)
│   └── .DS_Store  (14K)
├── docs/
│   ├── index.html  (2.66M)
│   └── trayectorias.html  (1.42M)
├── .DS_Store  (10K)
├── .gitignore  (1.42K)
